...
Public Class CariData
    ...
    Private Sub CariData_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            objkon.konek()
            Dim qry As New OleDbDataAdapter("Select tbbayar.kode_bayar, tbmahasiswa.nim, tbmahasiswa.nama_mahasiswa, tbmahasiswa.jurusan, tbmahasiswa.tahun_akademik, tbbayar.semester, tbbayar.keterangan from tbbayar INNER JOIN tbmahasiswa ON tbbayar.kode_mahasiswa = tbmahasiswa.kode_mahasiswa WHERE keterangan='LUNAS'", objkon.kon)
