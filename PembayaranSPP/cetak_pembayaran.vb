...
Public Class cetak_pembayaran
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "PembayaranSPP.cetak_pembayaran.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedcetak_pembayaran
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As cetak_pembayaran = New cetak_pembayaran()
        rpt.Site = Me.Site
        Return rpt
    End Function
